ccr=function(y,d,method="multinom",k=3,...){
  num=k
  option=method
  if(num==3){
    ...
    ccr=(sum(pv==1 & y==1)+ sum(pv==2 & y==2)+sum(pv==3 & y==3))/nn
    return(ccr)
  }else if(num==4){
    ...
    ccr=(sum(pv==1 & y==1)+ sum(pv==2 & y==2)+sum(pv==3 & y==3)+sum(pv==4 & y==4))/nn
    return(ccr)
  }else if(num==2){
    ...
    ccr=(sum(pv==1 & y==1)+ sum(pv==2 & y==2))/nn
    return(ccr)
  }
}
